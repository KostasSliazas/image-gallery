...
>If only JavaScript includes without config all images will be in list even logos with ```<img>``` tag. WHAT IS IN ```<body>``` or needs to add class 'gall7' to parent element of images.
